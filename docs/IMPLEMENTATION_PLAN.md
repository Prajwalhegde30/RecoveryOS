...
- [x] Keep pages under approximately 400–500 lines by extracting feature sections/components; the dashboard client is now 468 lines and shared presentation components live in `packages/ui/src/components`.
